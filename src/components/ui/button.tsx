...
/**
 * Button component variants with improved spacing and consistency
 * 
 * Changes from default shadcn:
 * - Reduced icon-text gap from gap-2 to gap-1.5 for tighter visual grouping
 * - Consistent radius of 0.5rem (matches --radius from design system)
 * - Outline variant uses card background for better distinction from page background
 */
